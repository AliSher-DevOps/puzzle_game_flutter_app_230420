...
import 'package:puzzle_game_flutter_app_230420/utils/utils.dart';
import 'package:puzzle_game_flutter_app_230420/models/models.dart';
    ...
    return Positioned(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: Colors.blue[300], borderRadius: BorderRadius.circular(6.0)),
        child: Stack(
...
class _BoardWidgetState extends State<BoardWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: EdgeInsets.only(top:40.0,left: 1.0,right: 1.0),
        child: Column(
      children: <Widget>[
        Container(
          child: Row(
...
Container(),
              Container(
                ...
                child: Center(
                  ...
                  children: <Widget>[Text("Score : ",style: TextStyle(
                    fontSize: 12 ,color: Colors.black87
                      ,
                    fontWeight: FontWeight.w700
                  ),), Text("${_board.score}",style: TextStyle(
                    color: Colors.red
                  ),)],
                )),
              ),
